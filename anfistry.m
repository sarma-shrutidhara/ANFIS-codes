...
Time = test_au(1:1000,1);
F_20 = test_au(1:1000,3);
%plot(time*1000,abs(F_20),'--k');

       plot(Time,abs(F_20),'-k','LineWidth',1.5,...
                       'MarkerEdgeColor','k',...
                       'MarkerFaceColor','k',...
                       'MarkerSize',5)
...
%plot(time*1000,abs(anfis_output),'-k');
       ...
       plot(Time,abs(anfis_output),'--r','LineWidth',1,...
                       'MarkerEdgeColor','r',...
                       'MarkerFaceColor','r',...
                       'MarkerSize',10)
...
%dlmwrite('outputFile.dat', [X Y avg_seismic_data_models], '-append', 'delimiter',',')
                    ...
                    xlabel('Temp(deg C)') 
                    grid on
                    legend('Input Res', 'Predicted Res' )
hold off
% index = 125:1124;
